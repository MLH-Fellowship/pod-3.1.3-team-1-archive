...
class CatCodingPanel {
	...
	private _getHtmlForWebview(webview: vscode.Webview, catGifPath: string) {
		...
		const scriptPathOnDisk = vscode.Uri.joinPath(this._extensionUri, 'src', 'js', 'main.js');
		...
		return `<!DOCTYPE html>
			...
			<head>
				...
				-->
				<meta http-equiv="Content-Security-Policy" content="default-src 'self' https://quotes.rest/qod https://newsapi.org/v2/top-headlines/sources; style-src ${webview.cspSource}; img-src ${webview.cspSource} https:; script-src 'nonce-${nonce}';">
