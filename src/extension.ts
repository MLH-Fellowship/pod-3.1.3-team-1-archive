	...
	private _getHtmlForWebview(webview: vscode.Webview, catGifPath: string) {
		...
		return `<!DOCTYPE html>
			...
			<head>
				...
				-->
				<meta http-equiv="Content-Security-Policy" content="default-src 'self' https://quotes.rest/qod https://app.daily.dev/api/graphql; style-src ${webview.cspSource}; img-src ${webview.cspSource} https:; script-src 'nonce-${nonce}';">
